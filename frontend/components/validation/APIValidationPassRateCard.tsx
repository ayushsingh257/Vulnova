...
interface APIValidationPassRateCardProps {
  passRate: number;
...
export const APIValidationPassRateCard: React.FC<APIValidationPassRateCardProps> = ({
  passRate,
  overallStatus,
  passedCount,
  failedCount,
    ...
    <Card className="border-zinc-800 bg-zinc-950/80 backdrop-blur-md">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400 mt-0.5">
              Automated API endpoint security assertion score & posture breakdown
            </p>
          </div>
        </div>
      ...
      <CardContent className="pt-6 grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
        ...
        <div className="flex flex-col items-center justify-center border-r border-zinc-800/80 pr-4">
          ...
          <span className="text-xs text-zinc-400">API Categories Passed</span>
        </div>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <span className="text-xs text-zinc-400">API Security Violations</span>
        </div>
      </CardContent>
    </Card>
  );
