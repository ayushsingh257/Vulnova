...
import { ShieldAlert, ShieldCheck, ArrowRight, Lock, Activity, FileText } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 border-b border-zinc-800/80 bg-zinc-950/80 backdrop-blur-xl px-6 py-4 flex items-center justify-between shadow-2xl">
      <div className="flex items-center space-x-6">
        ...
        <nav className="hidden md:flex items-center space-x-4 border-l border-zinc-800 pl-6 text-xs font-medium text-zinc-400">
          <a href="/trust" className="hover:text-zinc-100 transition-colors flex items-center space-x-1.5">
            <ShieldCheck className="h-3.5 w-3.5 text-red-400" />
            <span>Trust Center</span>
          </a>
          <a href="/security" className="hover:text-zinc-100 transition-colors flex items-center space-x-1.5">
