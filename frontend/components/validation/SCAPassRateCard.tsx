...
import { PackageCheck, AlertTriangle, XCircle, CheckCircle2 } from "lucide-react";
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";

interface SCAPassRateCardProps {
  passRate: number;
...
export const SCAPassRateCard: React.FC<SCAPassRateCardProps> = ({
  passRate,
  overallStatus,
  passedCount,
  failedCount,
    ...
    <Card className="border-zinc-800 bg-zinc-950/80 backdrop-blur-md">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <CardTitle className="text-base font-bold text-white">
              Software Composition & Supply Chain Posture
            </CardTitle>
            <p className="text-xs text-zinc-400 mt-0.5">
              Automated third-party dependency, lockfile integrity & open-source license assertion score
            </p>
          </div>
        </div>
      ...
      <CardContent className="pt-6 grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
        ...
        <div className="flex flex-col items-center justify-center border-r border-zinc-800/80 pr-4">
          ...
          <span className="text-xs text-zinc-400">SCA Controls Passed</span>
        </div>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <span className="text-xs text-zinc-400">Dependency Violations</span>
        </div>
      </CardContent>
    </Card>
  );
