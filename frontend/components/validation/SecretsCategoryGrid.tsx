...
interface SecretsCategoryGridProps {
  categories: SecretCategoryResultDTO[];
  onSelectCategory: (cat: SecretCategoryResultDTO) => void;
}

export const SecretsCategoryGrid: React.FC<SecretsCategoryGridProps> = ({
  categories,
  onSelectCategory,
}) => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {categories.map((cat) => (
        ...
        >
          ...
          {/* Secret Component Info */}
          <div className="text-xs text-zinc-400 font-mono truncate" title={cat.affected_secret || "Cryptographic Component"}>
            Target: {cat.affected_secret || "Cryptographic Component"}
          </div>
