...
export default function RegressionValidationPage() {
  ...
  const fetchResults = async () => {
    ...
    try {
      ...
      console.error("Failed to fetch regression validation results:", err);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="space-y-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 mt-0.5">
                Continuous security regression framework preventing reintroduction of fixed security vulnerabilities across OWASP Web/API, Infra, Exploits, SCA, Containers, Secrets & STRIDE
              </p>
            </div>
          </div>
        ...
        {loading ? (
          <div className="text-center py-12 text-zinc-500 text-sm">
            Evaluating Security Regression assertion suite...
          </div>
        ) : suiteResult ? (
          <>
            {/* Top Pass Rate Card */}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="text-sm font-bold text-white uppercase tracking-wider">
                  Security Regression Guard Results (REGRESSION1 - REGRESSION10)
                </h2>
          ...
          <div className="text-center py-12 text-zinc-500 text-sm">
            No regression validation results available. Click run above to execute.
          </div>
        )}
