...
│   │   │   ├── assessment/          # AssessmentService, ScanProfileRegistry, ScanPolicyEngine, RiskIntelligenceEngine, FindingDeduplicator, AssessmentCorrelationEngine, AssetInventoryService, ContinuousMonitoringService, ChangeDetectionEngine, DTOs
...
│   │   │   ├── entities/            # User, Organization, Target, Finding, CVSS, EPSS, Evidence, ScanProfile, ScanPolicy, AssetSnapshot, AssetChangeEvent entities
...
│   │   │   ├── db/                  # Async SQLAlchemy models (AssetSnapshotModel, AssetChangeEventModel), Alembic migrations, pgvector, Repositories (AssetInventoryRepository, AssetTrendRepository)
...
│   └── tests/                       # Pytest unit, integration, and security test suite (161 passed)
│
