...
interface ThreatDetailsModalProps {
  category: ThreatCategoryResultDTO | null;
  onClose: () => void;
}
        ...
        <div className="space-y-6">
          ...
          {category.failure_reason && (
            <div className="p-4 rounded-lg bg-amber-950/30 border border-amber-800/50 space-y-1">
              <div className="flex items-center space-x-2 font-bold text-amber-300 text-xs">
                ...
                <span>STRIDE Threat Model Diagnostic</span>
              </div>
          ...
          <div className="space-y-1.5">
            <span className="text-xs font-bold text-zinc-400 flex items-center space-x-1 uppercase tracking-wider">
              ...
              <span>Evaluated Architectural Component / Boundary</span>
            </span>
            <div className="p-3 rounded-lg bg-zinc-900 border border-zinc-800 text-xs font-mono text-orange-300">
              {category.affected_component || "Architectural Boundary"}
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-2 text-xs font-bold text-white uppercase tracking-wider">
              ...
              <span>Recommended STRIDE Threat Mitigation</span>
            </div>
