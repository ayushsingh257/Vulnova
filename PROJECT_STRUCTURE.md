...
│   │   │   ├── entities/            # User, Organization, Target, Finding, CVSS, EPSS, Evidence, ScanProfile, ScanPolicy, AssetSnapshot, AssetChangeEvent, TriageRecord, LLMProvider, LLMModel, PromptTemplate, AIFindingExplanation, AIImpactAnalysis, AttackPath, AttackPathStep, AIRemediationPlan, AIRemediationStep, AIPatchSuggestion entities
...
│   └── tests/                       # Pytest unit, integration, and security test suite (224 passed)
│
