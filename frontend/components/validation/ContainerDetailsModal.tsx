...
import { X, Wrench, AlertTriangle, Boxes } from "lucide-react";
import { Badge } from "@/components/ui/badge";

interface ContainerDetailsModalProps {
  category: ContainerCategoryResultDTO | null;
  onClose: () => void;
}
        ...
        <div className="space-y-6">
          ...
          {category.failure_reason && (
            <div className="p-4 rounded-lg bg-amber-950/30 border border-amber-800/50 space-y-1">
              <div className="flex items-center space-x-2 font-bold text-amber-300 text-xs">
                ...
                <span>Container Hardening Diagnostic</span>
              </div>
          ...
          <div className="space-y-1.5">
            <span className="text-xs font-bold text-zinc-400 flex items-center space-x-1 uppercase tracking-wider">
              ...
              <span>Evaluated Container Profile / Directive</span>
            </span>
            <div className="p-3 rounded-lg bg-zinc-900 border border-zinc-800 text-xs font-mono text-cyan-300">
              {category.affected_container || "Docker Container Profile"}
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-2 text-xs font-bold text-white uppercase tracking-wider">
              ...
              <span>Recommended Container Hardening</span>
            </div>
